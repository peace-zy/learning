...
sed -i '5830s/$/ and model._tp_plan is not None/' /opt/conda/lib/python3.10/site-packages/transformers/modeling_utils.py
cp ms-swift/internvl.py /opt/conda/lib/python3.10/site-packages/swift/llm/template/template/internvl.py
#sleep 100d
...
OUTPUT_DIR=Model/R2V_InternVL2_2B_v4-ms-swift-h100-${num_train_epochs}
