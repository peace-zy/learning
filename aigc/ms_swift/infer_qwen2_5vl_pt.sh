MODEL_PATH=Model/Qwen2.5-VL-3B-Instruct-add-token-R2V-h100-3/v0-20250411-145737/checkpoint-40000
...
swift infer \
    ...
    --result_path r2v_result_a100_6_1w_add_token.jsonl
    #--result_path r2v_result_a100_4w_add_token.jsonl
    #--result_path r2v_result_a100_local_6_1w.jsonl
    #--result_path r2v_result_a100_local_6_1w_h100.jsonl
    #--result_path r2v_result_a100_local_6_1w.jsonl
    #--infer_backend pt \
