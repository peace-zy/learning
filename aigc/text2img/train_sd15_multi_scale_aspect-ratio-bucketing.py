...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default='/mnt/bella/users/zhangyan/MultiModal/text2img/test/realisticVisionV51_v51VAE',
        required=True,
...
def get_unweighted_text_embeddings(
    ...
    if max_embeddings_multiples > 1:
        ...
        for i in range(max_embeddings_multiples):
            ...
            prompt_embeds = text_encoder(text_input_chunk)
...
def concat_encode_prompt(
    ...
    prompt_embeds, negative_prompt_embeds, pooled_prompt_embeds, negative_pooled_prompt_embeds = get_weighted_text_embeddings(
        tokenizer,
        text_encoder,
        device,
        prompt=prompt,
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for i, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                # ######################## webui版本 #######################
                prompt_embeds, _, pooled_prompt_embeds, _ = concat_encode_prompt(tokenizer, text_encoder, device=latents.device,
