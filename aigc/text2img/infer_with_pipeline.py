...
def main():
    ...
    parser.add_argument('--unet_path', type=str, default='./sd/ft_model/V_multi_scale/V07_3_scale_A100_3csv/checkpoint-20000/unet')
    # vae
    # parser.add_argument('--vae_path', type=str, default='./aigc_models/realisticVisionV51_v51VAE/')
    # width
    parser.add_argument('--width', type=int, default=576)
    # height
    parser.add_argument('--height', type=int, default=768)
    # save_dir
    parser.add_argument('--save_dir', type=str, default='./sd/infer_result/multi_scale/ckpt_50000_576_768/')
    ...
    for i, row in df.iloc[:].iterrows():
        ...
        if use_size_condition:
            image = pipe(prompt, width=width, height=height, num_inference_steps=25, negative_prompt=negative_prompt,
                        ...
                        generator=generator, max_embeddings_multiples=max_embeddings_multiples).images[0]
